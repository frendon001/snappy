    ...
    return (
      <div className="center-align">
        ...
        <div className="row" style={backgroundTopStyle}>
          <div className="col s12 white-text bottom-m-margin">
        ...
        <div className="row top-section-padding s4 blue-grey lighten-5">
          <div className="col s12 m4">
            ...
            <p className="features-item">
              A single credit ($1 value) is required to start sending out
              surveys to up 100,000 emails. Credits are available in 5 credit
              bundles.
            </p>
          </div>
          ...
          <div className="col s12 m4">
            ...
            <h4>Easy to use</h4>
            <p className="features-item">
              Quick and simple interface allows you to create and send surveys
              to any list people/customers. Sign up today and send out your
              first survey in under 10 minutes.
            </p>
          </div>
          ...
          <div className="col s12 m4">
            ...
            <p className="features-item">
              Snappy's dashboard allows you to take snapshot of all your
              existing surveys to view status at a glance. Select any survey to
        ...
        <div className="row snappy-dark-blue grey-text text-lighten-5 landing-section flex-align-wrapper">
          ...
          <div className="col s12 align-end">
            ...
            <p className="light-font">
              Copyright © {new Date().getFullYear()}. Snappy All rights
              reserved.
            </p>
          </div>
        </div>
